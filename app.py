# -----------------------------------------------------------------
# V9.1: "The Consultant" - Final Corrected Version
# - Includes all features: Radar Chart, Marketing Strategies, sidebar controls.
# - UI set to the light "Corporate Clean" theme.
# - Corrected the CSS to remove the custom font, fixing the text rendering bug.
# -----------------------------------------------------------------
...
# --- V9.1 "Corporate Clean" Theme (Corrected for Font Bug) ---
st.markdown("""
<style>
...
if len(features_to_cluster) < 2:
    ...
    if st.session_state.show_strategy:
        ...
        for i, row in cluster_summary_for_strategy.iterrows():
            ...
            st.markdown(f"#### Cluster {i}: {persona}")
